package io.transwarp.geo.udf.api;
...
public class ShowByRegionApiV3 {

  public ShowByRegionApiV3() {
  }
  ...
  public ListResult showByRegion(List<LongWritable> time_list, List<FloatWritable> longitude_list
    ...
    if (prov_id_list.get(0).toString().equals("031")) {
    ...
    for (int i = 1; i < time_list.size(); i++) {
      ...
      if (prov_id_list.get(i).toString().equals("031")) {
